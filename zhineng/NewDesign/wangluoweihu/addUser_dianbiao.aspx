<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addUser_dianbiao.aspx.cs" Inherits="family.wangluoweihu.addUser_dianbiao" %>
      ...
      <div class="new_main">
           <div class="contents">
               ...
               <div class="contents-r">
                    <ul>
                    <li><a href="dianbiao.aspx" title="查询电表">查询电表</a></li>
            
                    <li><a href="adddianbiao.aspx" title="添加电表">添加电表</a></li>
       
                    <li><a href="dianbiaomanage.aspx" title="管理电表">管理电表</a></li>
