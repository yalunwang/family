...
namespace ZKEShop.Common
{
    ...
    public class ZKRequest
    {
        ...
        /// <param name="strName">表单参数</param>
        /// <returns>表单参数的int类型值</returns>
        public static short GetFormShort(string strName)
        {
            return GetFormShort(strName, 0);
        }
        ...
        {
            return Utils.StrToShort(HttpContext.Current.Request.Form[strName], defValue);
        }
        /// <summary>
        /// 获得指定Url参数的Short类型值
        /// </summary>
        /// <param name="strName">Url参数</param>
        /// <returns>Url参数的int类型值</returns>
        public static short GetQueryShort(string strName)
        {
            return Utils.StrToShort(HttpContext.Current.Request.QueryString[strName], 0);
        }
        ...
        /// <param name="defValue">缺省值</param>
        /// <returns>Url参数的int类型值</returns>
        public static short GetQueryShort(string strName, short defValue)
        {
            return Utils.StrToShort(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        /// <summary>
        /// 获得指定Url或表单参数的Short类型值, 先判断Url参数是否为缺省值, 如为True则返回表单参数的值
        /// </summary>
        /// <param name="strName">Url或表单参数</param>
        /// <param name="defValue">缺省值</param>
        /// <returns>Url或表单参数的int类型值</returns>
        public static short GetShort(string strName, short defValue)
        {
            if (GetQueryInt(strName, defValue) == defValue)
                return GetFormShort(strName, defValue);
            else
                return GetQueryShort(strName, defValue);
        }
